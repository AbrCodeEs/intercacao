...
const data = [
...

  {
    title: '1872',
    name: 'Quirico Prosperi Boscheti',
    content: "Finalizada la guerra, Francia derrotada y económicamente deprimida, Quirico Prosperi, con 21 años, regresa a Brustico, Córcega, para casarse con Marie Luccioni Paoli.",
    img: carouselHistoria6.src,
  },
  {
    title: '1873-1874',
    name: 'Quirico Prosperi Boscheti',
    content: 'Nace su primer hijo, Paul Prosperi, y en 1874, amigos corsos en Venezuela lo convencen de viajar para trabajar en Carúpano, estado Sucre.',
    ...
    content: (
      <>
        <ul className="list-disc">
          ...
          <li>El 1 de Julio de 1882, compra la Casa Solariega, hoy en día sede de la Fundación Quirico Prosperi, lugar que se se convertiría en el corazón de un imperio agrícola de producción y comercialización de cacao, café y sarrapia, en El Rincón, municipio Benítez, Edo. Sucre.</li>
        </ul>
      </>
    ),
  ...
  },
  {
    title: '1886',
    name: 'Quirico Prosperi Boscheti',
    content: 'Nace su hijo Jaime Martin Prosperi  en la casa de la plantación de cacao. El Rincon, Edo Sucre',
    img: SecadoCacao.src
  },
  ...
  },
  {
    title: '1892',
    name: 'Quirico Prosperi Boscheti',
    content: 'Cambia la denominación de "El Rincón" a "Prosperi y Cía". tras comprar la participación de su hermano Ambrosio.',
  },
  {
    title: '1900',
    ...
    content: (
      <>
        <ul className="list-disc">
          ...
          <li>
            Se refugia en Trinidad, dejando a sus hijos mayores a cargo de la familia y los negocios. A finales del siglo XIX, su hijo Pablo se incorporó al negocio, posteriormente Martín a comienzos del XX.
          </li>
        </ul>
        <p>
    ...
    content: (
      <>
        <ul className="list-disc">
          ...
          <li>
          Sus restos reposan junto a su esposa Marie Luccioni Paoli en el Panteón de la Familia Prosperi en Carúpano, Venezuela.
          </li>
        </ul>
      </>
    ),
  },
  {
    title: '1933',
    name: 'Jaime Martin Prosperi',
    content: 'La iglesia original del Rincón fue destruida por el huracán que entró por el delta el 28 de junio de 1933, saliendo por el norte vía Carúpano-Margarita. Este ciclón dejó una devastación de las plantaciones de cacao y café del Rincón y zonas adyacentes.',
  },
  {
    title: '1940-1950',
    name: 'Jaime Martin Prosperi',
    content: 'La iglesia actual del Rincón es reconstruida por el hijo y nieto de Quirico Prosperi, Jaime Martin Prosperi  Luccioni, y Francisco Raffalli-Prosperi.',
  },
  {
    title: '1960',
    name: 'Jaime Martin Prosperi ',
    content: 'Jaime Martín Prosperi Luria, hijo de Martín Prosperi y Consuelo Luria Urdaneta fundó "Mercantil Prosperi S.A." y "Prosperi Caracas, C.A.", empresas dedicadas principalmente a la exportación de Cacao y Café.',
  },
  {
    title: '1975',
    name: 'Jaime Martin Prosperi ',
    content: 'Prosperi Caracas, C.A. se mantuvo como principal empresa exportadora hasta la Nacionalización de la Comercialización del Cacao, que, junto a las industrias del petróleo, el hierro y el café, pasaron a manos del Estado en 1975, por mandato del presidente Carlos Andrés Pérez.',
  },
  {
    title: '1991',
    name: 'Jaime Martin Prosperi ',
    content: 'La familia Prosperi tuvo que abandonar el negocio del cacao y café por una decisión política que, definitivamente, afectó la calidad y la producción de "El Mejor Cacao del Mundo". En el segundo gobierno de Carlos Andrés Pérez, en 1991, se desmontó el monopolio y se abrió a las empresas privadas para la exportación de cacao y café.',
  },
  {
    title: '1993',
    name: 'Alejandro Prosperi',
    content: 'Alejandro Prosperi, hijo de Jaime Martín Prosperi, decidió recuperar el negocio de exportación de**"El Mejor Cacao del Mundo"** y, junto a Martín Urrutia, principal productor de cacao de Barlovento, constituyó la empresa "Cacao Flor de Baba, C.A.", incorporando al negocio a sus hermanos Martín y Pablo.',
    img: AlejandroPROSPERI.src
  },
  {
    title: '2006',
    name: 'Alejandro Prosperi',
    content: 'Expandió el negocio de Cacao y Café más allá de las fronteras Venezolanas e inició en Colombia, junto a don Álvaro Afanador, la empresa "Gran Colombia Trading Ltda.", con sede en Bogotá, convirtiéndose en la primera empresa exportadora de Cacao Colombiano.',
  },
  {
    title: '2008',
    name: 'Alejandro Prosperi',
    content: 'Trabajó y apoyó incondicionalmente la conformación de la "Asociación Nacional de Productores de Cacao Venezolano". Se incorporó de manera integral a favor de los productores agrícolas; igualmente, se involucró a través de los gremios en la lucha y defensa de los productores y del agro. Fue nombrado director de Cacao en "La Confederación Nacional de Asociaciones de Productores Agropecuarios" (FEDEAGRO)',
  },
  {
    title: '2012',
    name: 'Alejandro Prosperi',
    content: (
      <>
        <p>
          ...
          también en la Fundación Quirico Prosperi, creada en 2012 por su bisnieto Alejandro
          también en la Fundación Quirico Prosperi, creada en 2012 por su bisnieto Alejandro
          Prosperi. Esta organización sin fines de lucro honra su memoria promoviendo la
          agricultura, la reforestación y la conservación de los valores históricos y culturales de
          Venezuela, especialmente en la zona de Paria.
        </p>
  ...
  },
  {
    title: '2014',
    name: 'Alejandro Prosperi',
    content: "La Casa del Cable Frances fue restaurada por el Arquitecto Jorge Thielen, En esta casa Vivio Wilfried, gran amigo de Alejandro Prosperi.",
    img: CasaDelCable.src,
  },
  {
    title: '2023',
    name: 'Alejandro Prosperi',
    content: "La fundación inauguró el vivero Wilfried Merle en honor a este gran ecologista-conservacionista alemán-venezolano, quien entregó su vida por la flora y la fauna de Paria, estado Sucre. Así, cada árbol frutal y maderable que sembremos, estaremos dejando su legado y su huella de amor y espíritu en toda Paria.",
    img: Vivero.src,
  },
  {
    title: '2024',
      ...
      >
        ...
        <div className="flex grow flex-row items-start justify-between px-3 py-2">
          <div>
            ...
            <div className="pl-3 my-5 flex w-full items-center justify-start">
              <button
                type="button"
            ...
            <div className="text-zinc-700 pl-5 py-3">
              <div className="flex flex-col border-zinc-800 border-l-2">
                ...
                <p className="pl-3 text-sm">Su legado no solo se refleja en la prosperidad agrícola y comercial que impulsó, sino también en la Fundación Quirico Prosperi, creada en 2012 por su bisnieto Alejandro Prosperi. Esta organización sin fines de lucro honra su memoria promoviendo la agricultura, la reforestación y la conservación de los valores históricos y culturales de Venezuela, especialmente en la zona de Paria.</p>
              </div>

              <div className="flex flex-col border-zinc-800 border-l-2 pt-3">
                <h1 className="pl-3 text-xl font-bold">2025</h1>
                <h2 className="pl-3 text-lg font-bold text-neutral-600">Alessia y Anabella Prosperi</h2>
                <p className="pl-3 text-sm">La Fundación Quirico Prosperi trabaja incansablemente para rescatar y difundir el legado de Quirico, fomentando el desarrollo sostenible y el sentido de pertenencia entre los venezolanos. Desde programas de música y danza hasta la siembra de árboles frutales y la preservación de la fauna, la fundación continúa escribiendo la historia de un hombre que, con esfuerzo y dedicación, transformó el destino de su familia y de toda una región.</p>
              </div>
            </div>
          </div>
        </div>
