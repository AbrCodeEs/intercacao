...
>(({ className, classNameWrapper, ...props }, ref) => {
  ...
  return (
    <div ref={carouselRef} className={cn('w-xs overflow-hidden lg:w-xl xl:w-full', classNameWrapper)}>
        <div
          ref={ref}
          className={cn(
            'flex',
  ...
  ({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          'absolute h-8 w-8 rounded-full disabled:opacity-0.5',
          orientation === 'horizontal'
            ? 'top-1/2 -left-8 -translate-y-1/2 md:-left-12 lg:-left-12 xl:-left-12'
            : 'top-1/2 -translate-y-1/2',
          !isHovered && 'opacity-50', // Control de visibilidad
          className,
        )}
