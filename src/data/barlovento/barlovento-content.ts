const es = {
  generalInformation: {
    ...
    sections: [
      ...
      {
        items: [
          { label: 'PRODUCCIÓN ANUAL (TM)', value: '4.200' },
  ...
  cocoaMap: [
    {
      ...
      content: [
        {
          type: 'paragraph',
          text: 'El perfil sensorial del cacao Sur del Lago nos presenta una propuesta gustativa estructurada y limpia, respaldada por una fermentación adecuada y una postcosecha bien ejecutada. Este lote revela un carácter pronunciado a cacao, con una intensidad media-alta (valor 4) que se convierte en el eje central de su identidad sensorial.',
        },
        {
          type: 'paragraph',
          text: 'En el plano aromático y de sabor, emergen notas de fruta seca (2.25) y fruta fresca (1.75), que aportan complejidad sin sobreponerse al perfil principal. Estas notas se complementan con un matiz de nuez (2), que caracteriza a este cacao, y una presencia baja de malta (1), que añade una ligera base terrosa. ',
        },
        {
          type: 'paragraph',
          text: 'Con una genética criolla estimada en 9%, se clasifica como un cacao acriollado. Aunque esta proporción no domina el perfil, contribuye a una cierta elegancia en boca, presente de forma sutil y agradable.',
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'paragraph',
          text: 'El análisis sensorial confirma que este lote de Sur del Lago es un cacao con buena estructura, sabores definidos y una limpieza destacable. Gracias a su ausencia de defectos negativos y una combinación balanceada de atributos positivos, es un cacao ideal para quienes buscan un perfil marcado a cacao con acompañamientos frutales secos, sabor a nuez y un amargor estructurado.',
        },
      ],
    ...
    },
    {
      ...
      content: [
        {
          type: 'paragraph',
          text: 'El perfil sensorial del cacao Barlovento nos revela una experiencia gustativa rica y balanceada, producto de un cuidadoso manejo post-cosecha. Este cacao destaca por su carácter marcado a cacao, que constituye la base de su identidad, ofreciendo un sabor intenso y redondo que define su esencia.',
        },
        {
          type: 'paragraph',
          text: 'En el espectro frutal, se identifican notas sutiles de fruta cítrica fresca, que aportan una ligera vivacidad sin dominar el conjunto. También están presentes matices de frutas dulces, que aportan dulzor natural y profundidad al sabor, elevando la complejidad del grano.',
        },
        {
          type: 'paragraph',
          text: 'Aunque el porcentaje de genética criolla es bajo, se perciben leves destellos de esa herencia sensorial en su categoría de acriollado, reflejando una suavidad en boca y elegancia que enriquecen la experiencia, aunque no son predominantes.',
        },
        {
          type: 'paragraph',
          text: 'En cuanto a los atributos técnicos, este cacao presenta una astringencia baja (valor de 1) y una amargura moderada (2.25), lo que se traduce en una sensación agradable y persistente en boca, sin dureza. La acidez está presente en niveles suaves (1.50), lo que contribuye a un perfil equilibrado.',
        },
        {
          type: 'paragraph',
          text: 'Este mapa sensorial confirma que el Barlovento es un cacao con personalidad, estructura y limpieza de sabor. Gracias a su alto nivel de fermentación, su ausencia de defectos negativos y su predominio de sabores naturales positivos, es ideal tanto para chocolateros que buscan perfiles definidos, como para quienes desean explorar la riqueza sensorial de un cacao venezolano con carácter y armonía.',
        },
      ],
      image: {
  ...
  location: {
    ...
    locationInfo: {
      ...
      details: [
        ...
        { label: 'State', value: 'Miranda' },
        { label: 'Subregion', value: 'Barlovento' },
        { label: 'Area', value: '2,500 km²' },
        {
          label: 'Average altitude',
          value: '10 - 50 masl (low coastal area, with some hills inland)',
        },
        { label: 'Inhabitants', value: '200,000' },
      ],
    },
    paragraphs: [
      'Barlovento es una región de paisajes exuberantes donde convergen el verde intenso de la vegetación tropical, ríos caudalosos y una costa que respira Caribe. Su geografía combina planicies húmedas y colinas suaves, creando un entorno privilegiado para el cultivo agrícola. El ambiente cálido, la brisa del mar y la riqueza de sus suelos hacen de este territorio un espacio naturalmente fértil, donde el cacao crece en armonía con su entorno y las tradiciones afrovenezolanas que le dan vida a la región.'
    ],
    ecology: {
      title: 'Ecología',
      paragraphs: [
...
const en = {
  generalInformation: {
    ...
    sections: [
      ...
      {
        items: [
          { label: 'ANNUAL PRODUCTION (MT)', value: '4.200' },
  ...
  cocoaMap: [
    {
      ...
      content: [
        {
          type: 'paragraph',
          text: 'The sensory profile of Sur del Lago cacao presents a structured and clean taste, supported by proper fermentation and a well-executed post-harvest. This lot reveals a pronounced cacao character, with a medium-high intensity (score 4), which becomes the central axis of its sensory identity.',
        },
        {
          type: 'paragraph',
          text: 'On the aromatic and flavor levels, notes of dried fruit (2.25) and fresh fruit (1.75) emerge, providing complexity without overpowering the main profile. These notes are complemented by a nutty nuance (2), which characterizes this cacao, and a low presence of malt (1), which adds a light earthy base.',
        },
        {
          type: 'paragraph',
          text: 'With an estimated 9% Criolla genetics, it is classified as a Criolla cacao. Although this proportion doesn\'t dominate the profile, it contributes to a certain elegance in the mouthfeel, present in a subtle and pleasant way.',
        },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      content: [
        {
          type: 'paragraph',
          text: 'The sensory profile of Barlovento cacao reveals a rich and balanced taste experience, the product of careful post-harvest handling. This cacao stands out for its pronounced cacao character, which forms the basis of its identity, offering an intense and rounded flavor that defines its essence.',
        },
        {
          type: 'paragraph',
          text: 'In the fruit spectrum, subtle notes of fresh citrus fruit are identified, providing a slight liveliness without overpowering the overall flavor. Sweet fruit nuances are also present, providing natural sweetness and depth to the flavor, enhancing the bean\'s complexity.'
        },
        {
          type: 'paragraph',
          text: 'Although the percentage of Criolla genetics is low, faint hints of that sensory heritage are perceived in its Criolla category, reflecting a smoothness and elegance in the mouth that enrich the experience, although they are not predominant.'
        },
        {
          type: 'paragraph',
          text: 'Regarding technical attributes, this cacao has low astringency (score of 1) and moderate bitterness (2.25), which translates into a pleasant and persistent mouthfeel, without harshness. Acidity is present at mild levels (1.50), which contributes to a balanced profile.'
        },
        {
          type: 'paragraph',
          text: 'This sensory map confirms that Barlovento is a cacao with personality, structure, and a clean flavor. Thanks to its high level of fermentation, its absence of negative defects, and its predominance of positive natural flavors, it is ideal for both chocolatiers seeking defined profiles and those wishing to explore the sensorial richness of a Venezuelan cacao with character and harmony.'
        },
      ],
      image: {
        alt: 'Sensory Map',
  ...
  location: {
    ...
    locationInfo: {
      ...
      details: [
        ...
        { label: 'Estado', value: 'Miranda' },
        { label: 'Subregión', value: 'Barlovento' },
        { label: 'Superficie', value: '2,500 km²' },
        {
          label: 'Altitud promedio',
          value: '10 - 50 msnm (zona costera baja, con algunas colinas hacia el interior)',
        },
        { label: 'Habitantes', value: '200,000' },
      ],
    },
    paragraphs: [
