    ...
    cocoaMap: [
      {
        ...
        content: [
          {
            type: 'quote',
            quote: langContent.cocoaMap[0].content[0].text,
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'quote',
            quote: langContent.cocoaMap[1].content[1].text,
          ...
          protocols: [
            {
              ...
              items: [
                ...
                {
                  category: 'list',
                  items: langContent.postHarvestBenefit.content[0].protocols[0].items[4].items,
                },
              ],
              mainImage: [
                {
