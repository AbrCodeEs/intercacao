    ...
    cocoaMap: [
      {
        ...
        content: [
          ...
          {
            type: 'quote',
            quote: langContent.cocoaMap[0].content[1].quote,
            author: langContent.cocoaMap[0].content[1].author,
            border: true,
          },
        ],
        image: {
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'quote',
            quote: langContent.cocoaMap[1].content[3].quote,
            author: langContent.cocoaMap[1].content[3].author,
            border: true,
          },
        ],
        image: {
          ...
          protocols: [
            {
              ...
              items: [
                ...
                {
                  category: 'keyValue',
                  key: langContent.postHarvestBenefit.content[1].protocols[0].items[4].key,
                  value: '',
                },
                {
                  category: 'list',
                  items: langContent.postHarvestBenefit.content[1].protocols[0].items[5].items,
                },
              ],
              mainImage: [
                {
